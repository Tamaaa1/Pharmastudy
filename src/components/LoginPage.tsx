...
interface LoginPageProps {
  onLogin: (email: string, password: string, role: 'coach' | 'peserta') => void;
...
export function LoginPage({ onLogin, onNavigateToRegister }: LoginPageProps) {
  ...
  const [role, setRole] = useState<'coach' | 'peserta'>('peserta');
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-primary mb-2">EduCoach</h1>
          <p className="text-muted-foreground">Platform Coaching & Pembelajaran</p>
        </div>
        ...
        <div className="bg-card rounded-3xl p-6 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={(value: 'coach' | 'peserta') => setRole(value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="peserta">Peserta (User)</SelectItem>
                </SelectContent>
              </Select>
            </div>
